...
public class LyricView extends View {
    ...
    private void inflateAttributes(AttributeSet attrs) {
        ...
        mTextSize = ta.getDimension(R.styleable.Lrc_textSize, 32.0f);
        mRows = ta.getInteger(R.styleable.Lrc_rows, 8);
        mDividerHeight = ta.getDimension(R.styleable.Lrc_dividerHeight, 12.0f);

        int normalTextColor = ta.getColor(R.styleable.Lrc_normalTextColor, 0xFF9E9898);
        int currentTextColor = ta.getColor(R.styleable.Lrc_currentTextColor,0xFF52AFE1);
        ta.recycle();
        // </end>
